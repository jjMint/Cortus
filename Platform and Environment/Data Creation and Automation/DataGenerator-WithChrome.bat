...
timeout 5
START /B powershell.exe .\procdumper.ps1 -Procdump 'C:\Users\admin\Desktop\Benign Dataset\procdump.exe' -processes chrome -dumpFolder 'C:\Users\admin\Desktop\Benign DataSet\'
timeout 5
